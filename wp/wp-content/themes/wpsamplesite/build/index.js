...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(wpSampleSiteData.root_url + "/wp-json/wpSampleSite/v1/search?term=" + this.searchField.val(), results => {
      this.resultsDiv.html(`
                <div class="row">
                    <div class="one-third">
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkwp_sample_site"] = globalThis["webpackChunkwp_sample_site"] || [];
